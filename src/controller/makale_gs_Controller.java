...
import servis.makale_gs_Service;
import servis.makale_gs_ServiceImpl;

@ManagedBean(name="makale_gs_Controller")
@SessionScoped


public class makale_gs_Controller {
	...
	*/
	...
	public void ekle_makale() 
	{

		makale_gs_Service makale_gs_Service = new makale_gs_ServiceImpl();
		makale_gs makale_gs = new makale_gs(makale_adi,makale_tarihi,makale_icerik,makale_resim_yolu);
		makale_gs_Service.insert(makale_gs); 

	}

	public void sil_makale(int id) {
		 
	}
	
	public void duzenle_makale(int id) {
